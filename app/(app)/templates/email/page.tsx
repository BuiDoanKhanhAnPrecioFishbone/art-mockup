  ...
  return (
    <div className="p-6">
      ...
      <div className="flex items-center gap-3 mb-5">
        ...
        <Link
          href="/templates/email/templates/new"
              ...
              <tr key={tpl.id} className="hover:bg-gray-50 transition-colors group">
                ...
                <td className="px-5 py-4">
                  <div className="flex items-center gap-2">
                    <Link
                      href={`/templates/email/templates/${tpl.id}`}
              ...
              {filtered.map((log) => (
                <tr key={log.id} className="hover:bg-gray-50/50 transition-colors">
                  ...
                  <td className="px-5 py-3.5">
                    <Link href={`/templates/email/logs/${log.id}`} className="font-medium text-gray-900 hover:text-purple-600 transition-colors leading-snug line-clamp-2 max-w-[220px]">
                      {log.name}
                    </Link>
                  </td>
                  {/* Job Name */}
                  ...
                  <td className="px-5 py-3.5">
                    <Link
                      href={`/templates/email/logs/${log.id}`}
